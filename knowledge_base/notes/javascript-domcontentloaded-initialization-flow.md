...
created: 2026-05-17
---
# JavaScript DOMContentLoaded Initialization Flow in src/js/main.js
`src/js/main.js` uses focused initializer functions that are called from one `DOMContentLoaded` handler, giving a predictable startup path for navbar behavior, animations, FAQ, form logic, and footer year.
