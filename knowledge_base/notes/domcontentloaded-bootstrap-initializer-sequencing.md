...
created: 2026-05-17
---
# DOMContentLoaded Bootstrap Initializer Sequencing in src/js/main.js
...
Implementation anchor: final `document.addEventListener("DOMContentLoaded", ...)` block in `src/js/main.js`.
